...
void xof_update_uint16_le(xof_context* ctx, uint16_t data) {
    const uint8_t data_le[2] = {(uint8_t)(data&0xFF), (uint8_t)(data>>8)};
...
void xof_update_x4_uint16s_le(xof_context_x4* ctx, const uint16_t data[4]) {
    const uint8_t data0_le[2] = {(uint8_t)(data[0]&0xFF), (uint8_t)(data[0]>>8)};
    const uint8_t data1_le[2] = {(uint8_t)(data[1]&0xFF), (uint8_t)(data[1]>>8)};
    const uint8_t data2_le[2] = {(uint8_t)(data[2]&0xFF), (uint8_t)(data[2]>>8)};
    const uint8_t data3_le[2] = {(uint8_t)(data[3]&0xFF), (uint8_t)(data[3]>>8)};
