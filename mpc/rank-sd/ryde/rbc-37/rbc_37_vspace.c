...
/**
 * \fn void rbc_37_vspace_set_random_full_rank_with_one(samplable_t* ctx, rbc_37_vspace o, uint32_t size) {
 ...
 */
void rbc_37_vspace_set_random_full_rank_with_one(samplable_t* ctx, rbc_37_vspace o, uint32_t size) {
