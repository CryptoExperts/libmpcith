...
void rbc_37_vec_set_random(samplable_t* ctx, rbc_37_vec o, uint32_t size);
void rbc_37_vec_set_random_x4(samplable_x4_t* ctx, rbc_37_vec const o[4], uint32_t size);
