...
/**
 * \fn void rbc_37_mat_set_random(samplable_t* ctx, rbc_37_mat m, uint32_t rows, uint32_t columns)
 ...
 * \param[in] columns Column size of the rbc_37_mat
 */
void rbc_37_mat_set_random(samplable_t* ctx, rbc_37_mat m, uint32_t rows, uint32_t columns) {
    for(size_t i = 0 ; i < rows ; ++i) {
