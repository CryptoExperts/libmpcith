...
/**
 * \fn void rbc_43_vspace_set_random_full_rank_with_one(samplable_t* ctx, rbc_43_vspace o, uint32_t size) {
 ...
 */
void rbc_43_vspace_set_random_full_rank_with_one(samplable_t* ctx, rbc_43_vspace o, uint32_t size) {
