...
/**
 * \fn void rbc_43_mat_set_random(samplable_t* ctx, rbc_43_mat m, uint32_t rows, uint32_t columns)
 ...
 * \param[in] columns Column size of the rbc_43_mat
 */
void rbc_43_mat_set_random(samplable_t* ctx, rbc_43_mat m, uint32_t rows, uint32_t columns) {
    for(size_t i = 0 ; i < rows ; ++i) {
