...
/**
 * \fn void rbc_31_mat_set_random(samplable_t* ctx, rbc_31_mat m, uint32_t rows, uint32_t columns)
 ...
 * \param[in] columns Column size of the rbc_31_mat
 */
void rbc_31_mat_set_random(samplable_t* ctx, rbc_31_mat m, uint32_t rows, uint32_t columns) {
    for(size_t i = 0 ; i < rows ; ++i) {
