...
/**
 * \fn void rbc_31_vec_set_random(samplable_t*, rbc_31_vec v, uint32_t size)
 ...
 * \param[in] size Size of the vector
 */
void rbc_31_vec_set_random(samplable_t* ctx, rbc_31_vec v, uint32_t size) {
...
void rbc_31_vec_set_random_x4(samplable_x4_t* ctx, rbc_31_vec const v[4], uint32_t size) {
  uint32_t bytes = (RBC_31_FIELD_M % 8 == 0) ? RBC_31_FIELD_M / 8 : RBC_31_FIELD_M / 8 + 1;
...
/**
 * \fn void rbc_31_vec_set_random_full_rank_with_one(samplable_t* ctx, rbc_31_vec o, uint32_t size) {
 ...
 * \param[in] size Size of the vector
 */
void rbc_31_vec_set_random_full_rank_with_one(samplable_t* ctx, rbc_31_vec o, uint32_t size) {
...
/**
 * \fn void rbc_31_vec_set_random_from_support(samplable_t* o, rbc_31_vec o, uint32_t size, const rbc_31_vec support, uint32_t support_size)
 ...
 */
void rbc_31_vec_set_random_from_support(samplable_t* ctx, rbc_31_vec o, uint32_t size, const rbc_31_vec support, uint32_t support_size, uint8_t copy_flag) {
