...
#define PARAM_SHARE_SIZE (PARAM_WIT_SIZE+PARAM_UNIF_SIZE)
#define PARAM_BR_SIZE (sizeof(vec_broadcast_t))
#define PARAM_DC_BR_SIZE (sizeof(vec_dc_broadcast_t))
...
#define get_size_of_dc_broadcast(sh_info) (PARAM_DC_BR_SIZE)
#define get_size_of_challenge(sh_info) (sizeof(vec_challenge_t))
#define get_size_of_dc_challenge(sh_info) (sizeof(vec_dc_challenge_t))
...
build_all_vector_operations_static(dc_br, vec_dc_broadcast_t, get_size_of_dc_broadcast)
...
build_alloc_operation_static(dc_challenge, vec_dc_challenge_t, get_size_of_dc_challenge)
