...
#define mpcith_sign(sig, siglen, m, mlen, sk, salt, seed) mpcith_tprs_ext_sign(sig, siglen, m, mlen, sk, salt, seed)
#define mpcith_sign_verify(sig, siglen, m, mlen, pk) mpcith_tprs_ext_sign_verify(sig, siglen, m, mlen, pk)
