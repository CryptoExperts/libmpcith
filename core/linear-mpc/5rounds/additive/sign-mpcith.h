...
#define mpcith_sign(sig, siglen, m, mlen, sk, salt, seed) mpcith_additive_based_sign(sig, siglen, m, mlen, sk, salt, seed)
#define mpcith_sign_verify(sig, siglen, m, mlen, pk) mpcith_additive_based_sign_verify(sig, siglen, m, mlen, pk)
